import type { LookTheme } from "./schema";

/** Renderer-neutral look styles (ADR 0049). Lengths are in PDF points. */
export const LOOK_FONT_SANS = "Inter";
...
export function createLookStyleIr(theme: LookTheme) {
...
export type LookStyleIr = ReturnType<typeof createLookStyleIr>;
export type LookStyleBox = LookStyleIr[keyof LookStyleIr];

export function rowColumnStyleIr(
  styles: LookStyleIr,
  split: "1/1" | "1/2" | "2/1",
  side: "start" | "end",
) {
