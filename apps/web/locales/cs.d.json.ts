...
declare const messages: {
  ...
  "Generator": {
    ...
    "subtitle": "Stejný ověřený doklad, jaký Invoicey používá u každé vystavené faktury. Na stránce upravujete koncept; stažené PDF je čisté.",
    "step1Title": "Začněte IČO",
    "step1Body": "ARES doplní dodavatele z registru. Na stránce už je vzor — číslo přepište, až budete chtít.",
    "step2Title": "Pište na fakturu",
    "step2Body": "Zvýrazněná pole jdou upravit. Součty a DPH se dopočítávají, takže matematiku nerozbijete.",
    "step3Title": "Stáhněte čisté PDF",
    "step3Body": "Pošleme doklad e-mailem a uschováme ho, až se přihlásíte. Náhled na stránce zůstává s vodoznakem.",
    "sampleBadge": "Předvyplněný vzor",
    "editorHint": "Klikněte na zvýrazněné pole a upravte ho. Součty a DPH se dopočítají.",
    ...
    "issueClientDic": "Přenesení daňové povinnosti potřebuje DIČ odběratele na faktuře.",
    "issueIssuerDic": "Doplňte DIČ dodavatele.",
    "issueIssuerEmail": "Doplňte platný kontaktní e-mail dodavatele — objeví se i u Vystavil(a).",
    "issueIssuerIco": "IČO dodavatele musí mít 8 číslic.",
    "issueIssuerName": "Doplňte název dodavatele.",
    "issueClientName": "Doplňte název odběratele.",
    "issueLine": "Každá položka potřebuje popis.",
    "issueZip": "Použijte české PSČ (např. 110 00).",
    "issueBank": "Zkontrolujte číslo účtu nebo IBAN.",
    "issueGeneric": "Zkontrolujte zvýrazněná pole na faktuře a zkuste to znovu.",
    "issuer": "Dodavatel",
    "client": "Odběratel",
    "ico": "IČO",
    ...
    "gateLegal": "Pokračováním souhlasíte s <terms>podmínkami</terms> a <privacy>zásadami ochrany soukromí</privacy>.",
    ...
    "faqEyebrow": "FAQ",
    "faqTitle": "Otázky",
    "faqLead": "Opravdový vystavený doklad, ne maketa. Tohle byste měli vědět před stažením.",
    "faq1Q": "Je to opravdová faktura?",
    "faq1A": "Ano. Dostane číslo, snímky dodavatele i odběratele, uložené PDF a ISDOC. Soubor ke stažení je stejný doklad, jaký Invoicey uchovává — ne vodoznaková maketa.",
    "faq2Q": "Co se stane, až se přihlásím?",
    "faq2A": "Přihlaste se stejným e-mailem a workspace i s touto fakturou vám předáme. Odkaz z e-mailu funguje i tehdy, když použijete Google nebo GitHub s jinou adresou.",
    "faq3Q": "Proč chcete e-mail?",
    "faq3A": "Abychom poslali PDF a fakturu uschovali, dokud si workspace nepřevezmete. Z tohoto formuláře vás do newsletteru nepřidáme.",
    "faq4Q": "Musím být plátce DPH?",
    "faq4A": "Ne. Plátce DPH nechte vypnutý, pokud nejste registrovaní — režim DPH se skryje a položky jdou bez daně. Přenesení daňové povinnosti se objeví jen u plátce a tehdy odběratel potřebuje DIČ.",
    "faq5Q": "Přepíše ARES to, co jsem vyplnil(a)?",
    "faq5A": "ARES se spustí, až IČO bude mít 8 číslic. Vzorová čísla při načtení stránky lookup nespouští. Po doplnění z ARES můžete pole pořád upravit ručně.",
  ...
  "DriveOauth": {
    ...
    "openApp": "Otevřít Invoicey Drive",
    "errorTitle": "Tento Mac se nepodařilo připojit",
    "errorDescription": "Začněte znovu z Invoicey Drive na Macu.",
    "missingCode": "Callback párování neobsahoval autorizační kód."
  },
  "Referral": {
  ...
  "App": {
    ...
    "nav": {
      ...
      "bankConnections": "Banky",
      "requestPayment": "Vyžádat platbu",
      "paymentRequests": "Výzvy",
    ...
    "section": {
      "invoices": {
        "home": {
          "title": "Moje faktury",
          "description": "Návrhy, vystavené doklady a jejich stav."
        },
        "recurring": {
          "title": "Opakované faktury",
          "description": "Plán, který za vás založí další návrh."
        },
        "import": {
          "title": "Importovat staré faktury",
          "description": "Přineste PDF z jiného nástroje do Invoicey."
        },
        "fromJson": {
          "title": "Faktura z JSON",
          "description": "Vložte JSON a zobrazte náhled PDF."
        }
      },
      "payments": {
        "home": {
          "title": "Párování",
          "description": "Příchozí bankovní platby a potvrzená spárování."
        },
        "requests": {
          "title": "Výzvy",
          "description": "Požádejte o peníze QR kódem, bez faktury."
        },
        "connections": {
          "title": "Banky",
          "description": "Napojení výpisu jen pro čtení."
        }
      }
    },
    "a11y": {
  ...
  "Invoices": {
    "list": {
      "title": "Moje faktury",
      "subtitle": "Návrhy i vystavené faktury na jednom místě. Filtrujte podle stavu a pak vystavte, odešlete nebo vyberte platbu.",
    ...
    "builder": {
      "title": "Nová faktura",
      "subtitle": "Vyplňte strany a položky a pak vystavte. Náhled PDF se roztáhne s dokladem.",
      "back": "Zpět na faktury",
      "backToInvoice": "Zpět na fakturu",
    ...
    "import": {
      "title": "Importovat staré faktury",
      "subtitle": "Nahrajte PDF z jiného nástroje. Soubory s ISDOC se vyplní samy, u ostatních doplníte hlavičku ručně.",
      "catalogTitle": "Přenášíte z jiného nástroje?",
      "catalogHint": "Vyberte nástroj, který jste používali. Nahrání souborů funguje. Propojení (Connect) je zatím zamčené.",
    ...
    "fromJson": {
      "title": "Faktura z JSON",
      "subtitle": "Vložte fakturu jako JSON, zkontrolujte ji a zobrazte náhled PDF. Hodí se pro skripty, MCP nebo rychlý test.",
  ...
  "Recurring": {
    "list": {
      "title": "Opakované faktury",
      "subtitle": "Plán uložíte z vystavené faktury. Invoicey v termínu založí další návrh, vystavení a odeslání zůstává na vás.",
  ...
  "Issuers": {
    ...
    "welcome": {
      ...
      "skipping": "Přeskakuji…",
      "skipHint": "Nastavení můžete dokončit později. Před vystavením faktury je firma potřeba.",
      "steps": {
        "workspace": "Prostor",
        "business": "Firma",
        "bank": "Účet",
      ...
      "aresTitle": "Najděte svou firmu",
      "aresHint": "Zadejte IČO a předvyplníme veřejně evidované údaje.",
      "businessDetails": "Potvrďte údaje firmy",
      "contactEmailHint": "Zkontrolujte údaje, hlavně kontaktní e-mail na fakturách.",
      ...
      "uploadHint": "Nejde o OCR: funguje jen s vloženým ISDOC.",
      "continue": "Pokračovat",
      "identityRequired": "Vyplňte povinná pole.",
      "bankRequired": "Vyplňte bankovní účet a IBAN.",
      "bankTitle": "Přidejte bankovní účet",
      "bankForBusiness": "Tento účet bude na fakturách firmy {business}. Invoicey peníze nepřevádí.",
      "doneTitle": "Můžete začít fakturovat",
      "doneBody": "Číslování a e-mailové šablony mají rozumné výchozí hodnoty. Logo a další údaje doplníte později v nastavení firmy.",
      "goDashboard": "Přejít na přehled",
      "createFirstInvoice": "Vytvořit první fakturu",
      "editBusiness": "Nastavení firmy",
      "workspaceHint": "Tady budou žít vaše faktury. Název můžete později změnit.",
      "workspaceTitle": "Pojmenujte pracovní prostor",
      "workspaceBody": "Prostor drží vaše firmy, klienty a faktury.",
      ...
      "enterManually": "Údaje vyplním sám",
      "importInvoice": "Mám PDF faktury s ISDOC",
      "finishSetup": "Dokončit nastavení",
      "finishing": "Dokončuji…",
      "saving": "Ukládám…",
      "importHistory": "Nahrát historii faktur",
      "pathTitle": "Nastavte firmu z faktury",
      "pathHint": "Nahrajte poslední vystavenou fakturu. Z ISDOC doplníme firmu, účet a prvního klienta.",
      "pathUploadTitle": "Nahrát poslední fakturu",
      "pathUploadHint": "PDF s vloženým ISDOC. Nejde o OCR.",
      "pathIco": "Mám IČO — najít v ARES",
      "reviewTitle": "Zkontrolujte, co jsme našli",
      "reviewHint": "Doplňte kontaktní e-mail, pokud v dokladu chybí. Ostatní údaje můžete ještě upravit.",
      "reviewIssuer": "Firma",
      "reviewBank": "Účet",
      "reviewClient": "Klient",
      "reviewNoClient": "V dokladu není odběratel",
      "editExtracted": "Upravit údaje",
      "parseErrors": {
        "missing_file": "Vyberte PDF fakturu.",
        "not_pdf": "Nahrajte soubor PDF.",
        "no_isdoc": "V PDF není vložený ISDOC. Nahrajte fakturu z nástroje, který ISDOC přikládá (Invoicey, FakturaOnline, Fakturoid, iDoklad…).",
        ...
        "parse_failed": "Nepodařilo se načíst údaje z PDF."
      },
      "migrate": {
        "title": "Přenést historii faktur?",
        "hint": "Nahrajte PDF z vašeho dosavadního nástroje, nebo to nechte na později v Invoices → Import. Přímé propojení (Connect) přidáme později.",
        "skip": "Přeskočit pro teď",
        "uploadFiles": "Nahrát soubory",
        "connect": "Propojit",
        "soon": "Brzy",
        "notes": {
          "oauthLater": "Přihlášení přes OAuth přidáme později. Zatím nahrajte PDF.",
          "apiKeyLater": "Napojení přes API klíč přidáme později. Zatím nahrajte PDF.",
          "clientCredentialsLater": "Napojení přes údaje aplikace přidáme později. Zatím nahrajte PDF.",
          "onPrem": "Účetní program běží u vás. Hostované propojení nepřipojíme — nahrajte exportované PDF.",
          "isdocZipLater": "Později přijmeme i ISDOC ZIP. Dnes fungují PDF s vloženým ISDOC, jinak archivní import."
        }
      }
    },
    "emailForm": {
  ...
  "Settings": {
    ...
    "bankConnections": {
      ...
      "pageDescription": "Připojte výpis jen pro čtení. Invoicey naimportuje příchozí platby a navrhne spárování. Peníze nikdy neodesílá.",
  ...
  "Payments": {
    "title": "Párování",
    "description": "Příchozí bankovní platby zůstávají návrhy, dokud je nepotvrdíte. Částečné platby i storna zůstanou v přehledu.",
    "bankConnections": "Bankovní spojení",
    "requestPayment": "Vyžádat platbu",
    ...
    "suggestedDescription": "Invoicey navrhne shodu, když sedí účet, částka a variabilní symbol. Každý návrh potvrďte nebo zamítněte.",
    ...
    "incomingDescription": "Platby stažené z napojené banky.",
    ...
    "historyDescription": "Platby, které jste potvrdili, přidali ručně, nebo stornovali.",
    ...
    "openRequest": "Otevřít",
    "syncNow": "Načíst z banky"
  },
  "PaymentRequests": {
    "list": {
      "title": "Výzvy k platbě",
      "description": "Požádejte o platbu bez faktury. Plátce dostane QR, Invoicey hlídá napojený účet.",
      "empty": "Zatím žádné výzvy k platbě.",
      "untitled": "Výzva k platbě",
      "create": "Vyžádat platbu",
      "filterAll": "Vše"
    },
    "create": {
      "title": "Vyžádat platbu",
      "description": "Zadejte částku. Invoicey vytvoří variabilní symbol a QR pro napojený účet.",
      "back": "Zpět na výzvy",
      "amount": "Částka",
      "amountHint": "QR požádá přesně o tuto částku v CZK.",
    ...
    "wait": {
      ...
      "refreshInterrupted": "Aktualizace z banky trvá o něco déle. Budeme to zkoušet dál.",
      "received": "Platba dorazila",
      "receivedBody": "Částka {amount} z {requested} je potvrzená v přehledu plateb."
    },
    "public": {
      "title": "Platba pro {issuer}",
      "description": "Naskenujte QR nebo zkopírujte údaje. Po odeslání platby stránku obnovte — potvrzení se tu zobrazí.",
      "qrLabel": "QR kód pro platbu",
      "account": "Účet",
      "variableSymbol": "Variabilní symbol",
      "copyAccount": "Zkopírovat číslo účtu",
      ...
      "partialNote": "Už dorazilo {amount}. QR žádá o zbývajících {remaining}.",
      "paidEyebrow": "Uhrazeno",
      "paidTitle": "Uhrazeno · {issuer}",
      "paidDescription": "Platba je potvrzená. Znovu platit nemusíte.",
  ...
  "Admin": {
    ...
    "workspaceDetail": {
      ...
      "overrides": {
        ...
        "detachLabel": "Odpojit Polar a převzít správu",
        "detachHint": "Nutné u workspace placených přes Polar. Polar už nebude vlastnit tarif; předplatné v Polaru zrušte zvlášť, pokud nechcete dál platit.",
        "save": "Uložit výjimky",
      ...
      "plan": {
        ...
        "billingAuthority": "Správa tarifu",
        "polarManaged": "Polar",
        "manualAuthority": "Ruční",
        "seats": "Místa",
