...
declare const messages: {
  ...
  SlackLink: {
    ...
    description: "Potvrďte, že tento Slack účet smí fakturovat v aktuálním pracovním prostoru.";
    confirm: "Propojit se Slackem";
    ...
    workspaceHint: "Nové faktury ze Slacku půjdou sem. Starší Slack faktury v jiném workspace se nemění. Workspace přepnete v postranním panelu a odkaz otevřete znovu.";
    signedInAs: "Přihlášeni jako {email}";
  ...
  Settings: {
    ...
    integrations: {
      slackIdentity: {
        ...
        empty: "Zatím žádný Slack účet. Napište botovi DM — pošle odkaz k potvrzení.";
        slackUser: "Slack uživatel {id}";
        team: "Tým {id}";
        unlink: "Odpojit";
        unlinkFailed: "Odpojení selhalo";
        unlinkSuccess: "Slack účet odpojen";
        useCurrentWorkspace: "Použít {name}";
