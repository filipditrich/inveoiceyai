...
declare const messages: {
  ...
  Invoices: {
    ...
    ai: {
      ...
      viewUsage: "Využití a limity";
      lastUsage: "Poslední běh spotřeboval {tokens} tokenů";
      outOfTokens: "Tento pracovní prostor nemá zbývající AI tokeny.";
      errorGeneric: "Generování konceptu se nezdařilo. Zkuste to znovu.";
      invalidDraft: "Model vrátil neplatný koncept. Upravte popis a zkuste znovu.";
      openDraft: "Otevřít koncept";
      editInBuilder: "Upravit ve formuláři";
      previewEmpty: "Vygenerujte koncept pro náhled PDF…";
      bestResults: "Pro nejlepší výsledek uveďte:";
      hintClient: "jméno klienta nebo IČO";
      hintLine: "položku nebo službu";
      hintAmount: "částku s DPH nebo bez DPH";
      hintDue: "datum splatnosti";
      manageClients: "Přidat nebo spravovat klienty";
      builderLink: "Použít strukturovaný formulář";
    };
    email: {
  ...
  Settings: {
    ...
    apiKeys: {
      ...
      whichKeySlack: "Slack bot a Eve HTTP nejdou přes tento klíč (Connect / ops klíče).";
      docsMcp: "MCP docs";
    ...
    slack: {
      ...
      howDraftBody: "Bot připraví fakturu, připojí PDF a ISDOC a odkaz do webové aplikace.";
      ...
      accessBody: "Nespárovaní Slack uživatelé nedostanou žádnou relaci — bot jim pošle DM s odkazem na potvrzení v Invoicey. Propojení platí pro jeden Invoicey účet a jeden workspace. Allow/Deny ve vlákně může kliknout kdokoli v kanálu; držte bota v soukromém kanálu s lidmi, kteří smí fakturovat.";
      operatorTitle: "Technické nastavení nasazení";
      operatorIntro: "Tato část je určená správci nasazení. Připojení probíhá přes Vercel CLI; osobní API klíč Slack neautorizuje.";
      copied: "Zkopírováno";
      copy: "Kopírovat";
      docsLink: "Podrobný návod pro Slack";
      step1Title: "Deploy s Eve flagem";
      step1Body: "Nastavte VERCEL_USE_EXPERIMENTAL_FRAMEWORKS=1 a Node 24+. Bez toho se /eve/v1/* nevygeneruje a Slack tiše nefunguje.";
      step2Title: "Vercel Connect → /eve/v1/slack";
      step2Body: "Connect drží Slack credentials (žádné ruční SLACK_*). UID musí sedět s agentem (slack/invoicey).";
      step3Title: "Scopes a eventy + reinstall";
      step3Body: "message.channels (a message.groups pro privátní kanály); scopes mimo jiné channels:history, groups:history, im:history, im:write, chat:write, app_mentions:read, files:write, files:read. Po změně scopes vždy reinstall Slack app.";
      step4Title: "Env a healthcheck";
      step4Body: "DATABASE_URL, AI Gateway / OIDC, NEXT_PUBLIC_APP_URL, UPLOADTHING_TOKEN dle potřeby. Eve HTTP používá EVE_API_KEY nebo MCP_API_KEY — ne osobní PAT ze Settings.";
    };
    integrations: {
      ...
      slackIdentity: {
        ...
        description: "Jeden Slack účet patří jednomu Invoicey uživateli a jednomu workspace. Nespárované zmínky bot odmítne.";
        connected: "Propojeno";
        emptyTitle: "Zatím žádný Slack";
        empty: "Napište Invoicey botovi DM ve Slacku. Pošle vám odkaz k potvrzení v prohlížeči.";
        fromSlack: "Ze Slacku";
        toWorkspace: "Do workspace";
    ...
    incomingInvoices: {
      ...
      setupTitle: "Nastavení příjmu e-mailů";
      setupBadge: "Nastavení správce";
      setupHint: "Tato adresa začne přijímat poštu až po nastavení Resend Inbound a DNS. Pokud chybí MX záznam, odesílatel dostane chybu „Adresa nenalezena“ ještě předtím, než se e-mail dostane do Invoicey.";
      setupStepDomain: "Přidejte {domain} v Resendu jako receiving domain a zapněte Receiving.";
      setupStepMx: "Zkopírujte MX záznam, který Resend zobrazí pro {domain}, do DNS s prioritou 10 (nejnižší prioritou na tomto subdoméně).";
      setupStepWebhook: "Vytvořte webhook email.received na /api/webhooks/resend-inbound a jeho podpisový secret nastavte do RESEND_INBOUND_WEBHOOK_SECRET.";
  ...
  IncomingInvoices: {
    nextAction: {
      ...
      resolve_exception: "Další krok: před pokračováním vyřešte výjimku.";
      waiting: "Další krok: vyčkejte, než pravidla připraví schvalovací úkol.";
      approve: "Další krok: dokončete požadované schválení.";
      schedule_payment: "Další krok: přidejte ji do platební dávky.";
      configure_payment: "Další krok: doplňte platební údaje nebo vyřešte překážku platby.";
      view_payment_run: "Další krok: sledujte fakturu v platební dávce.";
      none: "Není nutná žádná další akce.";
    };
    title: "Přijaté faktury";
    ...
    gate: {
      ...
      configureTitle: "Platební údaje vyžadují pozornost";
      configureHint: "Před vytvořením dávky doplňte údaje příjemce a platby nebo vyřešte aktuální překážku.";
