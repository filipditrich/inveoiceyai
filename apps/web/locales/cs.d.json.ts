...
declare const messages: {
  ...
  ToastDescriptions: {
    ...
    issuer_deleted: "Podnikatel byl odebrán z tohoto workspace.";
  ...
  App: {
    ...
    workspaceSwitcher: {
      ...
      createDescription: "Nový prostor má vlastní dodavatele, klienty a faktury. Přepnutí zároveň nastaví výchozí prostor pro API klíče.";
      nameLabel: "Název";
  ...
  Dashboard: {
    ...
    issuerFilter: {
      ...
      description: "Zaměřte všechny přehledy a grafy na jedno podnikání.";
    };
    recent: {
  ...
  Invoices: {
    ...
    email: {
      ...
      suppressed: "Adresa je na suppress seznamu (bounce/complaint). Manuální odeslání je stále možné.";
      subject: "Předmět";
      to: "Komu";
      cc: "Kopie (volitelné)";
  ...
  Issuers: {
    ...
    welcome: {
      ...
      skipping: "Přeskakuji…";
      uploadLabel: "Rychlý start — nahrát vystavenou fakturu";
      uploadPending: "Načítám údaje z PDF…";
      uploadHint: "Pouze PDF s vloženým ISDOC (bez OCR). Údaje dodavatele a banky se předvyplní.";
      continue: "Pokračovat";
    ...
    emailForm: {
      ...
      body: "Text zprávy";
      displayName: "From display šablona";
      attachIsdoc: "Přikládat ISDOC ve výchozím stavu";
      overdueReminders: "Posílat připomínky po splatnosti";
      reminderInterval: "Interval připomínek (dny)";
      paymentReceived: "Posílat potvrzení o přijetí platby";
    };
    numbering: {
      tokensHint: "Dostupné tokeny. Ruční změna counteru může vytvořit mezery v řadě.";
      nextNumber: "Další číslo: {preview}";
      invalidTemplate: "(neplatná šablona)";
      counterChanged: "Counter byl změněn — zkontrolujte, že nevzniknou duplicity nebo mezery.";
      template: "Šablona";
      padding: "Padding (#)";
      reset: "Reset";
      resetYearly: "Roční";
  ...
  Settings: {
    ...
    bankConnections: {
      ...
      unnamedIssuer: "Dodavatel bez názvu";
      ...
      needIssuer: "Nejdřív vytvořte dodavatele, ke kterému účet patří.";
      issuerLabel: "Dodavatel, který platby přijímá";
      ...
      fio: {
        ...
        connectDescription: "V Fio Internetbankingu vytvořte token jen pro čtení a vložte ho sem. Invoicey ho ověří proti dnešnímu výpisu a uloží šifrovaně. Výchozí přijímací účet vybraného dodavatele se aktualizuje na ověřený Fio účet.";
