...
declare const messages: {
  ...
  "Marketing": {
    ...
    "pricing": {
      ...
      "packsTitle": "Balíčky AI tokenů",
      "packsDescription": "Jednorázově koupené tokeny. Balíček nikdy nezmění tarif workspace.",
      "packNames": {
        "tokens_small": "Balíček 2M tokenů",
        "tokens_medium": "Balíček 10M tokenů",
        "tokens_large": "Balíček 50M tokenů"
      },
      "packsBuy": "Koupit",
      "taxNote": "Ceník v Kč, DPH je v ceně."
    },
    "companions": {
  ...
  "App": {
    ...
    "settings": {
      ...
      "navDescriptions": {
        ...
        "billing": "Tarif, Polar a balíčky tokenů",
      ...
      "billing": {
        ...
        "pageDescription": "Přejděte na Pro, kupte balíčky AI tokenů a spravujte Polar portál. Návrat z pokladny sám o sobě nic nepřičte.",
        "notConfigured": "Předplatné v tomto prostředí ještě není zapnuté.",
        "plan": {
          "title": "Tarif workspace",
          "subtitle": "Platbu vybírá Polar. Oprávnění tarifu pořád určuje Invoicey.",
          "unknown": "Tarif",
          "manage": "Spravovat platby",
          "polarManaged": "Tento workspace platí přes Polar.",
          "manualManaged": "Tento workspace nemá Polar předplatné. Stávající Pro zůstává, dokud se nepřihlásíte k platbě.",
          "status": "Stav Polar: {status}",
          "periodEnd": "Aktuální období končí {date}"
        },
        "offers": {
          "pro_monthly": "Pro měsíčně",
          "pro_yearly": "Pro ročně",
          "tokens_small": "Malý balíček",
          "tokens_medium": "Střední balíček",
          "tokens_large": "Velký balíček"
        },
        "packs": {
          "title": "Balíčky AI tokenů",
          "subtitle": "Jednorázově koupené tokeny. Zůstanou, dokud je nespotřebujete. Refundace může vytvořit dluh a pozastavit AI v Invoicey.",
          "buy": "Koupit"
        },
        "banner": {
          "pastDue": "Platba za tento workspace selhala. Aktualizujte platební metodu, aby Pro zůstalo.",
          "canceling": "Pro zůstává aktivní do konce zaplaceného období.",
          "cta": "Spravovat platby"
        },
        "return": {
          "pageDescription": "Polar potvrzuje platbu. Invoicey změní tarif nebo tokeny až po podepsaném webhooku.",
          "titleReady": "Platba přišla",
          "titlePending": "Čekáme na potvrzení",
          "fulfilled": "Workspace už ukazuje změnu z Polar. Můžete se vrátit k předplatnému nebo využití.",
          "pending": "Když jste právě zaplatili, obnovte stránku za chvíli. Úspěšný návrat sám o sobě nic nepřičte.",
          "back": "Zpět na předplatné",
          "usage": "Zobrazit využití"
        },
        "errors": {
          "not_configured": "Předplatné není nastavené.",
          "forbidden": "Pro tento workspace nemůžete spravovat platby.",
          "unknown_offer": "Tato nabídka není k dispozici.",
          "custom_plan": "Sponzorované tarify nepoužívají Polar pokladnu.",
          ...
          "portal_failed": "Portál plateb se nepodařilo otevřít."
        }
      },
      "scopes": {
        "account": {
