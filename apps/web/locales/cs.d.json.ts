...
declare const messages: {
  ...
  Assistant: {
    ...
    card: {
      ...
      discard: "Zahodit";
      discarded: "Návrh {title} byl zahozen.";
      actionFailed: "Akce se nezdařila. Zkuste to znovu.";
      checkBeforeIssuing: "Zkontrolujte před vystavením.";
      assumedNotice: "Doplněno za vás — neuvedli jste. Změňte níže, nebo mi to napište.";
      dueDate: "Splatnost";
      currency: "Měna";
