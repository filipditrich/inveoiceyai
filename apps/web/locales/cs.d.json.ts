...
declare const messages: {
  ...
  "Marketing": {
    ...
    "pricing": {
      "eyebrow": "Ceník",
      "title": "Dokud je Invoicey v betě, je všechno zdarma.",
      "description": "Žádná karta, žádné odčítávání zkušební doby. Až se spustí placené tarify, dozvíte se to s dostatečným předstihem.",
      "betaBadge": "V betě zdarma",
      "freeName": "Free",
      "freePrice": "0 Kč",
      "freePeriod": "/ měsíc",
      ...
      "proName": "Pro",
      "proPrice": "0 Kč",
      "proPeriod": "/ měsíc po dobu bety",
      "proDescription": "Všechno z Free a navíc lidé, banky a vlastní vzhled faktur.",
      "proCta": "Získat Pro zdarma",
      "proCtaSignedIn": "Otevřít přehled",
