            ...
            <>
              ...
              <div className="p-1">
                <div
                  ...
                  className="hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground outline-hidden relative flex cursor-pointer select-none items-center justify-center rounded-md px-2 py-1.5 text-sm"
                >
                  Clear filters
                </div>
              </div>
