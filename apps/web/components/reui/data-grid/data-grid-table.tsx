  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="bg-primary shadow-xs absolute left-0 top-0 -translate-x-1/2 rounded-b-sm"
        style={{ width: 5 }}
      />
    </div>
  );
...
function DataGridTableLoader() {
  ...
  return (
    <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
      <div className="text-muted-foreground bg-card flex items-center gap-2 rounded-lg border px-4 py-2 text-sm font-medium leading-none">
    ...
    <Subscribe source={row.table.atoms.rowSelection}>
      {() => (
        <>
          <div
            className={cn(
              "bg-primary inset-s-0 absolute bottom-0 top-0 hidden w-[2px]",
      ...
      <tr>
        ...
        >
          <div className="flex items-center justify-center">
            <svg
              className="text-muted-foreground -ml-1 mr-3 h-5 w-5 animate-spin"
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
            >
