  ...
  const renderMenuContent = () => (
    <>
      {field.searchable !== false && (
        <>
          <Input
            ...
            className={cn(
              "border-input bg-transparent! h-8 rounded-none border-0 px-2 text-sm shadow-none",
      ...
      <div className="relative flex max-h-full">
        <div
          className="flex max-h-[min(var(--available-height),24rem)] w-full scroll-pb-2 scroll-pt-2 flex-col overscroll-contain"
          role="listbox"
          id={`${baseId}-listbox`}
        >
          {isAsync && loading && allFilteredOptions.length === 0 ? (
            ...
            <ScrollArea className="**:data-[slot=scroll-area-scrollbar]:m-0 size-full min-h-0 [&_[data-slot=scroll-area-viewport]]:h-full [&_[data-slot=scroll-area-viewport]]:overscroll-contain">
              {/* Selected items */}
...
function FilterValueSelector<T = unknown>({
  ...
  if (field.customRenderer) {
    return (
      <ButtonGroupText className="hover:bg-accent aria-expanded:bg-accent bg-background dark:bg-input/30 outline-hidden whitespace-nowrap text-start">
...
function FilterSubmenuContent<T = unknown>({
  ...
  return (
    <div className="flex flex-col" onMouseEnter={onActive}>
      {field.searchable !== false && (
        <>
          <Input
            ...
            className={cn(
              "bg-transparent! h-8 rounded-none border-0 px-2 text-sm shadow-none",
              "focus-visible:border-border focus-visible:ring-0 focus-visible:ring-offset-0",
      ...
      <div className="relative flex max-h-full">
        <div
          className="outline-hidden flex max-h-[min(var(--available-height),24rem)] w-full scroll-pb-2 scroll-pt-2 flex-col overscroll-contain"
          role="listbox"
          id={`${baseId}-listbox`}
                ...
                <>
                  <div className="relative">
                    ...
                    {enableShortcut && shortcutLabel && (
                      <Kbd className="bg-background absolute right-2 top-1/2 -translate-y-1/2 border">
                        {shortcutLabel}
                      </Kbd>
                    )}
                  </div>
