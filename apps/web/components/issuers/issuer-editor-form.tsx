  ...
  return (
    <form className="mx-auto max-w-2xl space-y-8" onSubmit={onSubmit}>
      ...
      <section className="space-y-4 rounded-md border p-4">
        <h2 className="text-sm font-medium">E-mail (výchozí)</h2>
        <input name="emailDefaultSubject" type="hidden" value={emailSubject} />
        <input name="emailDefaultCoverText" type="hidden" value={emailCover} />
        <input
          name="emailDisplayNameTemplate"
          type="hidden"
          value={emailDisplayName}
        />
        <input
          name="emailAttachIsdocByDefault"
          type="hidden"
          value={emailAttachIsdoc ? "true" : "false"}
        />
        <input
          name="emailOverdueRemindersEnabled"
          type="hidden"
          value={emailOverdue ? "true" : "false"}
        />
        <input
          name="emailOverdueReminderIntervalDays"
          type="hidden"
          value={emailReminderDays}
        />
        <input
          name="emailSendPaymentReceivedEmail"
          type="hidden"
          value={emailPaymentReceived ? "true" : "false"}
        />
