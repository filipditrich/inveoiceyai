...
function makeNoBuyerIdsNoEmail(): Invoice {
  ...
  invoice.payment.instructionsAfter = "Díky! Stačí napsat, až bude odesláno.";
  invoice.items = [
    {
      position: 1,
...
export const demoInvoiceExamples: InvoiceDemoExample[] = [
  {
    id: "basic-non-vat",
    label: "Neplátce · transfer · 0% DPH",
    invoice: cloneBaseInvoice(),
  },
  {
  ...
  {
    id: "regular-vat-payer",
    label: "Plátce DPH · 21% · 1 položka",
    invoice: makeRegularVatPayer(),
  },
  {
    id: "regular-mixed-vat",
    label: "Plátce DPH · mix 12% + 21%",
    invoice: makeRegularMixedVat(),
  },
  {
    id: "proforma-card",
    label: "Proforma · platba kartou",
    invoice: makeProforma(),
  },
  { id: "advance-cash", label: "Zálohová · hotovost", invoice: makeAdvance() },
  {
    id: "reverse-charge",
    label: "Reverse charge · EU odběratel",
    invoice: makeReverseCharge(),
  },
  { id: "oss-eu", label: "OSS · EU odběratel", invoice: makeOss() },
  {
    id: "credit-note",
    label: "Dobropis · záporné částky",
    invoice: makeCreditNote(),
  },
  {
    id: "minimal-buyer",
    label: "Bez IČO/DIČ/email odběratele",
    invoice: makeNoBuyerIdsNoEmail(),
  },
];
