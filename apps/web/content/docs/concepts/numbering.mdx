...
description: Templates, tokens, yearly resets and why numbers are never reused.
---
...
<Callout title="Avoid slashes">
  ...
  subjects. It works — it is just consistently mildly annoying.
</Callout>
...
With `never`, the counter simply keeps climbing.
