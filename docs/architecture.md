...
| `EMAIL_FROM`                                   | Invoice From header (`Invoicey <invoices@invoicey.app>`)                                                | Vercel + `.env.local`          | Plan 11 / 32           |
| `EMAIL_SYSTEM_FROM`                            | System From header (`Invoicey <noreply@invoicey.app>`)                                                  | Vercel + `.env.local`          | Plan 11 / 32           |
