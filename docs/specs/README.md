...
| `invoice-issue-as-service.md` | Plan 37              | Stateless bulk PDF render (`InvoiceSchema[]` → ISDOC.PDF / ZIP); first consumer is NFCtron vendor-fee attachments                    |
| `invoicey-pocket.md`          | Plan 38              | Native receive-only iPhone companion, device pairing, collection API, live settlement                                                |
| `notifications.md`            | Plan 38              | Durable event outbox, in-app inbox, delivery retries, and APNs adapter                                                               |
