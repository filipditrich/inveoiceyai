...
| [`plan-23-moneta-adapter.md`](./plan-23-moneta-adapter.md)                     | Plan 23 — MONETA read-only adapter           |
...
| [`plan-31-invoicey-cli.md`](./plan-31-invoicey-cli.md)                         | Plan 31 — Invoicey CLI                       |
| [`plan-36-payment-requests.md`](./plan-36-payment-requests.md)                 | Plan 36 — Payment requests + watch sessions  |
| [`plan-37-invoice-issue-as-service.md`](./plan-37-invoice-issue-as-service.md) | Plan 37 — Invoice issue as a service         |
